...
This mechanism has been integrated into Bitcore-Node-SunCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/suncoinpay/insight-api-suncoin#web-socket-api](https://github.com/suncoinpay/insight-api-suncoin#web-socket-api)
* API: [https://github.com/suncoinpay/insight-api-suncoin#instantsend-transactions](https://github.com/suncoinpay/insight-api-suncoin#instantsend-transactions)
...
By default, the SunCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SunCoin Core daemon:
