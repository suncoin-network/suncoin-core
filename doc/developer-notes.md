...
SunCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as SunCoin Core, where everyone uses
...
pay attention to for reviewers of SunCoin Core code.

General SunCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SunCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
