...
Only requiring some minor changes is suncoin.cpp.
...
Changes to suncoin.cpp
----------------------
suncoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
