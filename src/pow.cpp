...
unsigned int static DarkGravityWave(const CBlockIndex* pindexLast, const Consensus::Params& params) {
    /* current difficulty formula, suncoin - DarkGravity v3, written by Evan Duffield - evan@suncoin.org */
    const arith_uint256 bnPowLimit = UintToArith256(params.powLimit);
    // lets boot up the system the first 100 blocks
    int64_t nPastBlocks = 100;
