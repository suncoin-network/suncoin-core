...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("SunCoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  suncoin-cli [options] <command> [params]  " + _("Send command to SunCoin Core") + "\n" +
                  "  suncoin-cli [options] help                " + _("List commands") + "\n" +
                  "  suncoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
