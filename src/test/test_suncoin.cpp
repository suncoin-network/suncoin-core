...
#define BOOST_TEST_MODULE SunCoin Test Suite

#include "test_suncoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_suncoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
