 ...
 *
 *   // network
 *   CSunCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.suncoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSunCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSunCoinNetwork(UniValue objIn)
    {
...
// // can be under: SunCoinNetwork
// //   -- signature requirements : Key1(User)
// class CSunCoinNetworkVariable : public CGovernanceObject
// {
// private:
