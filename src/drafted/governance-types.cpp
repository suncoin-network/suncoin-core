...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SunCoinNetwork") type = SunCoinNetwork;
    if(strType == "SunCoinNetworkVariable") type = SunCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SunCoinNetwork) s = "SunCoinNetwork";
    if(type == SunCoinNetworkVariable) s = "SunCoinNetworkVariable";
