    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SUNCOIN-light"), QVariant("light"));
    //ui->theme->addItem(QString("SUNCOIN-light-hires"), QVariant("light-hires"));
    //ui->theme->addItem(QString("SUNCOIN-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("SUNCOIN-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("SUNCOIN-traditional"), QVariant("trad"));
