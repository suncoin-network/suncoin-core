    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("SunCoin Core");
    QString versionText     = QString(tr("Version 1.0"));
    QString copyrightTextBtc   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Dash Core developers"));
    QString copyrightTextDash   = QChar(0xA9)+QString(" 2017-2018 ") + QString(tr("The SunCoin.Network Community"));
