    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SunCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About SunCoin Core"));
...
All the SunCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SUN, 0.1 SUN, 1 SUN and 10 SUN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://suncoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://suncoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SunCoin Core is shutting down...") + "<br /><br />" +
