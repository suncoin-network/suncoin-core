    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("SunCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SunCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and suncoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SunCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SunCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SunCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SunCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SunCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a suncoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SunCoin Core help message to get a list with possible SunCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SunCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SunCoin Core"); // default title
